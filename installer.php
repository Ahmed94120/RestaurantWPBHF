...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20231002_restaurantbhf_d5bc52f1ca4b84246022_20231002231308_archive.zip';
        const ARCHIVE_SIZE       = '328777129';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd5bc52f-02231308';
        const SECONDARY_PACKAGE_HASH = '499bb8e-02231308';
        const VERSION            = '1.5.6';
